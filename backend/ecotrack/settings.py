...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': env('LOG_FILE', default='logs/ecotrack.log'),
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
...
ENABLE_AI_RECOMMENDATIONS = env.bool('ENABLE_AI_RECOMMENDATIONS', default=True)
ENABLE_SOCIAL_FEATURES = env.bool('ENABLE_SOCIAL_FEATURES', default=True)
ENABLE_CORPORATE_FEATURES = env.bool('ENABLE_CORPORATE_FEATURES', default=False)
